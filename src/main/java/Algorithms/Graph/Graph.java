 ...
 * At most one Edge per vertex pair is allowed in this Algorithms.Graph.
 * 
 * Note that the Algorithms.Graph is designed to manage the Edges. You
...
public class Graph {
     ...
     * 
     * @param vertices The initial Vertices to populate this Algorithms.Graph
     */
     ...
     * exists in the Algorithms.Graph.
     * 
     * @param one The first vertex to add
     * @param two The second vertex to add
     * @return true iff no Edge relating one and two exists in the Algorithms.Graph
     */
     ...
     * @return true iff no Edge already exists in the Algorithms.Graph
     */
    public boolean addEdge(Vertex one, Vertex two, int weight){
        ...
        //ensures the Edge is not in the Algorithms.Graph
     ...
     * @return true iff this Algorithms.Graph contains the Edge e
     */
    ...
    /**
     * This method removes the specified Edge from the Algorithms.Graph,
     * including as each vertex's incidence neighborhood.
     * 
     * @param e The Edge to remove from the Algorithms.Graph
     * @return Edge The Edge removed from the Algorithms.Graph
     */
     ...
     * @return true iff this Algorithms.Graph contains vertex
     */
     ...
     * as the parameter exists in the Algorithms.Graph, the existing Vertex is overwritten
     * only if overwriteExisting is true. If the existing Vertex is overwritten,
     * the Edges incident to it are all removed from the Algorithms.Graph.
     * 
     * @param vertex
     * @param overwriteExisting
     * @return true iff vertex was added to the Algorithms.Graph
     */
    ...
    /**
     * 
     * @return Set<String> The unique labels of the Algorithms.Graph's Vertex objects
     */
