...
public class PassingCars {
    ...
    public static void main(String[] args) {
        ...
        int test1 = sl.solution(new int[]{0,1,0,1,1});
        int test2 = sl.solution(new int[]{0,0,0,0});
        int test3 = sl.solution(new int[]{1,0,1,1});

        int dave1 = sl.solution(new int[]{0,1,0,1,1});
        int dave2 = sl.solution(new int[]{0,0,0,0,0});
        int dave3 = sl.solution(new int[]{1,0,1,1});
