 ...
 *
 * Add Custom comparator from : https://www.callicoder.com/java-priority-queue/
 * *
 */
...
public class PriorityQueue {
    ...
    java.util.PriorityQueue<String> pQueue;
    ...
    public void testIt() {
        ...
        pQueue =  new java.util.PriorityQueue<String>(stringLengthComparator);
